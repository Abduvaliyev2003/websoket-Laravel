...
<body>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav me-auto">
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('chat') }}">{{ __('Chats') }}</a>
                        </li>
                        <li class="nav-item">
    ...
    <script>
        // Assuming you have the "auth()->user()" available in your template
